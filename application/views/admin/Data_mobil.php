<div class="main-content">
  <section class="section">
    ...
    <a href="<?php echo base_url('admin/data_mobil/tambah_mobil')?>" class="btn btn-primary mb-4"><i class="fas fa-plus fa-sm"></i> Tambah Data</a>
          ...
          foreach($mobil as $mb) : ?>
            <tr>
              ...
              <td>
                ...
                <a onClick="return confirm('Yakin ingin menghapus ?')" class="btn btn-sm btn-danger" href="<?php echo base_url('admin/data_mobil/delete_mobil/').$mb->id_mobil ?>" class ="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
              </td>
            </tr>
        <?php endforeach; ?>
      </tbody>
