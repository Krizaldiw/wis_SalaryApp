        ...
        <div class="row">
         <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="id_mobil" value="<?php echo $mb->id_mobil ?>"></input>
            <select name="kode_type" class="form-control">
              <option value="<?php echo $mb->kode_type?>"><?php echo $mb->kode_type?></option>
              <?php foreach($type as $tp) : ?>
                <option value="<?php echo $tp->kode_type ?>"> <?php
                echo $tp->nama_type ?>
              <?php endforeach; ?>
            </select>
            ...
            <div class="form-group">
              <label>Gambar</label>
              <input type="file" name="gambar" class="form-control md-6">
            </div>
