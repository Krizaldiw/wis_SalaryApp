        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-7">
              ...
              <a class="btn btn-sm btn-danger ml-5" href="<?php echo base_url('admin/data_mobil') ?>">Kembali</a>
              <a class="btn btn-sm btn-warning" href="<?php echo base_url('admin/data_mobil/update_mobil/'.$dt->id_mobil) ?>">Update</a>
            </div>
          </div>
        </div>
      </div>
